...
public class RecruiterController {
    ...
    public String saveJob(
        ...
        if (file != null && !file.isEmpty()) {
            // NẾU CÓ CHỌN LOGO MỚI -> Lưu file mới
            String logoFileName = uploadFileService.handleSaveUploadFile(file, "job_logos");
            job.setLogo(logoFileName);
        } else {
            // NẾU KHÔNG CHỌN LOGO MỚI -> Lấy logo mặc định từ CompanyProfile
            if (currentUser.getCompanyProfile() != null && currentUser.getCompanyProfile().getCompanyLogo() != null) {
