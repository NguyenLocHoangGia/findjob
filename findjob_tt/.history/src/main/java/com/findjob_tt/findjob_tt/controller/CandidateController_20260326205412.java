...
public class CandidateController {
    ...
    public ResponseEntity<String> deleteNotification(@RequestParam("id") Long id, Principal principal) {
        try {
            ...
            // In lỗi ra màn hình Terminal (Console) để Debug nếu database có vấn đề
    ...
    // Trang quản lý thông tin đơn ứng tuyển
    ...
    public String viewMyApplications(Principal principal, Model model) {
        ...
        // Lấy thông tin ứng viên đang đăng nhập
        ...
        return "candidate/my-applications"; // Trỏ đến file giao diện JSP
    }
