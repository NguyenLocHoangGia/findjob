...
public class RecruiterController {
    ...
    public String toggleJobStatus(@PathVariable Long id, Principal principal, RedirectAttributes redirectAttributes) {
        ...
        if (job != null && job.getUser().getEmail().equals(principal.getName())) {
            ...
            // Logic toggle: PENDING -> CLOSED, CLOSED -> APPROVED, APPROVED -> CLOSED
            if ("PENDING".equals(currentStatus) || "CLOSED".equals(currentStatus)) {
                job.setStatus("CLOSED".equals(currentStatus) ? "APPROVED" : "CLOSED");
            ...
            String statusText = "APPROVED".equals(job.getStatus()) ? "MỞ" : "ĐÓNG";
