...
public class AdminController {
    ...
    public String approveJob(@RequestParam("jobId") Long jobId,
            ...
            @RequestParam(value = "keyword", required = false) String keyword,
            @RequestParam(value = "status", required = false) String status) { // Thêm biến page
        ...
        // Redirect về lại đúng trang đang đứng
        String redirectUrl = "redirect:/admin/jobs?page=" + page;
