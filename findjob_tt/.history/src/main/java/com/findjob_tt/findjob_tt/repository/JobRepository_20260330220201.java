...
public interface JobRepository extends JpaRepository<Job, Long> {
        ...
        // Cập nhật luôn hàm lấy toàn bộ công việc mặc định (chỉ lấy job đang mở và approved)
        List<Job> findByIsActiveTrueAndStatusOrderByCreatedAtDesc(Status.APPROVED);

        List<Job> findByIsActiveTrueAndStatusOrderByCreatedAtDesc(Status status);
