...
<body>
    ...
    <script>
        ...
        // Trong tương lai, dữ liệu này sẽ được lấy từ API của Spring Boot qua AJAX
        const mockData = {
            month: {
                ...
                options: {
                    ...
                    onClick: (e, activeEls) => {
                        if (activeEls.length > 0) {
                            ...
                            alert('Bạn vừa bấm vào: ' + clickedLabel + '\n\nĐây là nơi chúng ta sẽ gọi API Backend để tải dữ liệu chi tiết bên trong móc thời gian này!');
        ...
        function initCategoryChart() {
            ...
            categoryChartInstance = new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: ['IT - Phần mềm', 'Marketing', 'Kế toán', 'Bán hàng', 'Khác'],
                    datasets: [{
                        data: [45, 25, 15, 10, 5],
