                                ...
                                <tr class="user-row" 
                                    ...
                                    <td class="text-center align-middle">
                                        <c:choose>
                                            ...
                                            <c:when test="${user.active}">
                                                <a href="/admin/users/toggle-status/${user.id}" class="btn btn-sm btn-outline-danger fw-medium rounded-pill px-3 shadow-sm" onclick="return confirm('Bạn có chắc chắn muốn KHÓA tài khoản này? Người dùng sẽ bị văng ra ngoài và không thể đăng nhập lại.');">
