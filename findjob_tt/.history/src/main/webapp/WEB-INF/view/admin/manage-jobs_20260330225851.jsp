...
<body>
    ...
    <div class="d-flex justify-content-center gap-2">
        ...
        <a href="/job/${job.id}" class="btn btn-sm btn-outline-info" target="_blank" title="Xem trước">
            <i class="bi bi-eye"></i>
        </a>
