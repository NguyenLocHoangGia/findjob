            ...
            <div class="container-fluid px-4">
                ...
                <div class="collapse navbar-collapse" id="adminMenu">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-4 gap-2">
                        <li class="nav-item">
                            <a class="nav-link text-white fw-medium active" href="/admin/dashboard"><i
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white fw-medium" href="/admin/manage-jobs"><i
                                    class="bi bi-briefcase me-1"></i> Kiểm duyệt Tin</a>
                        </li>
                    </ul>
