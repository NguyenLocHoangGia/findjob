    ...
    <script>
       ...
       // 2. BIỂU ĐỒ TRÒN (ĐÃ KẾT NỐI API THẬT & CÓ PHẦN TRĂM)
        function initCategoryChart() {
            // Kích hoạt plugin DataLabels (Hiển thị % lên trên biểu đồ)
            Chart.register(ChartDataLabels);

            // Fetch data từ API Spring Boot
            fetch('/api/admin/chart/categories')
                ...
                .then(data => {
                    ...
                    categoryChartInstance = new Chart(ctx, {
                        type: 'doughnut',
                        data: {
                            labels: data.labels, // Data thật từ DB
                            datasets: [{
                                data: data.values, // Data thật từ DB
                        ...
                        options: {
                            ...
                            layout: {
                                padding: 25 // Bóp nhỏ biểu đồ để chữ không bị tràn
                            },
                            plugins: { 
                                ...
                                datalabels: {
                                    ...
                                    formatter: (value, ctx) => {
                                        ...
                                        // Tính % và làm tròn 1 chữ số thập phân
                                        if (sum === 0) return "0%";
                ...
                .catch(error => {
                    ...
                    document.getElementById('categoryChart').parentElement.innerHTML = '<p class="text-danger text-center mt-5">Không tải được dữ liệu</p>';
                });
        }
        ...
        function updateCharts() {
            ...
            initGrowthChart(viewType === 'day' ? 'day' : 'month'); // Đang dùng mock data nên chỉ test 2 loại
        }
