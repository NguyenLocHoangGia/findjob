            ...
            <div class="col-md-5">
                <div class="card shadow-sm border-0 rounded-4 p-4 my-5">
                    ...
                    <form action="/register" method="POST">
                        ...
                        <!-- Chia role -->
                        <div class="mb-3">
                            <label class="form-label fw-bold d-block text-start">Bạn muốn tham gia với vai trò gì?</label>
                            <div class="d-flex gap-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="roleName" id="roleCandidate" value="ROLE_CANDIDATE" checked>
                                    <label class="form-check-label" for="roleCandidate">
                                        <i class="bi bi-person-badge text-primary"></i> Ứng viên (Tìm việc)
                                    </label>
                                </div>
                                
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="roleName" id="roleRecruiter" value="ROLE_RECRUITER">
                                    <label class="form-check-label" for="roleRecruiter">
                                        <i class="bi bi-buildings text-success"></i> Nhà tuyển dụng (Tuyển người)
                                    </label>
                                </div>
                            </div>
                        </div>
