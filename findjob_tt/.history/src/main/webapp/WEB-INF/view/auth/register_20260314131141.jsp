            ...
            <div class="col-md-5">
                <div class="card shadow-sm border-0 rounded-4 p-4 my-5">
                    ...
                    <form id="registerForm" action="/register" method="POST">
                        ...
                        <input type="hidden" name="roleName" id="hiddenRoleName" value="">

                        <button type="button" class="btn btn-success w-100 py-2 fs-5 fw-bold rounded-3 mb-3" onclick="triggerRoleModal()">
                            Đăng ký
                        </button>
                    </form>
