                                                ...
                                                <td class="text-center align-middle">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${job.status == 'CLOSED'}">
                                                            <span class="badge bg-secondary-subtle text-secondary border border-secondary border-opacity-25 px-3 py-2 rounded-pill">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                                                            <c:if test="${job.status == 'APPROVED'}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item text-warning" href="/recruiter/toggle-job-status/${job.id}">
                                                                        <i class="bi bi-power me-2"></i>Tắt tin (Đóng)
                                                                    </a>
                                                                </li>
                                                            ...
                                                            <c:if test="${job.status == 'CLOSED'}">
                                                                <li>
                                                                    <a class="dropdown-item text-success" href="/recruiter/toggle-job-status/${job.id}">
                                                                        <i class="bi bi-power me-2"></i>Mở lại tin
                                                                    </a>
                                                                </li>
                                                                <li><hr class="dropdown-divider"></li>
                                                                <li>
