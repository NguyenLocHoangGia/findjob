                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <c:forEach var="job" items="${currentUser.jobs}" varStatus="status">
                                            <tr>
                                                <td class="text-center fw-bold text-muted">${status.index + 1}</td>
                                                <td>
                                                    <a href="/job/${job.id}" target="_blank" class="job-title-link fw-bold d-block mb-1">
                                                        ${job.title}
                                                    </a>
                                                ...
                                                <td class="text-muted small">
                                                    ${not empty job.formattedCreatedAt ? job.formattedCreatedAt : 'Vừa xong'}
                                                </td>
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="/recruiter/job/${job.id}/candidates" class="btn btn-sm btn-outline-primary" title="Xem danh sách ứng viên">
                                                            <i class="bi bi-people-fill"></i>
                                                        </a>
                                                        <a href="/recruiter/edit-job/${job.id}" class="btn btn-sm btn-outline-warning ms-1" title="Chỉnh sửa tin">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </a>
                                                        <button class="btn btn-sm btn-outline-danger ms-1" 
                                                                onclick="confirmDelete('${job.id}', '${job.title}')" title="Xóa tin này">
                                            ...
                                            <tr>
                                                <td colspan="5" class="text-center py-5">
                                                    <div class="py-4">
                                                        ...
                                                        <a href="/recruiter/post-job" class="btn btn-primary btn-sm mt-2">Đăng ngay</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:if>
