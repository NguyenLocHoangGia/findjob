                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow-sm border-0" style="max-width: 900px;">
                        <div class="card-body p-4">
                            ...
                            <form action="/recruiter/job/save" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" name="description" rows="6" required placeholder="Nhập mô tả công việc, yêu cầu kỹ năng, quyền lợi..."></textarea>
                                </div>
