                                    ...
                                    <tbody id="job-tbody">
                                        <c:forEach var="job" items="${jobs}" varStatus="status">
                                            ...
                                            <tr class="job-row" 
                                                ...
                                                data-status="${(!job.isActive || fn:toUpperCase(job.status) == 'REJECTED') ? 'closed' : ((empty job.status || fn:toUpperCase(job.status) == 'PENDING') ? 'pending' : 'active')}">
                                                ...
                                                <td class="text-center align-middle">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${empty job.status || fn:toUpperCase(job.status) == 'PENDING'}">
