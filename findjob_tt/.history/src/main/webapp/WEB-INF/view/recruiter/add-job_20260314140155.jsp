                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="/recruiter/job/save" method="POST" enctype="multipart/form-data">
                                ...
                                <div id="previewContainer" class="mb-4 text-center <c:if test='${empty company.companyLogo}'>d-none</c:if>">
                                    <p class="text-muted small mb-2">Bản xem trước Logo:</p>
        ...
        function previewLogo(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    previewContainer.classList.remove('d-none'); // HIỆN: Xóa class d-none
                }
                ...
                if(defaultLogo) {
                    ...
                    previewContainer.classList.remove('d-none'); // HIỆN
                } else {
                    previewImg.src = "";
                    previewContainer.classList.add('d-none'); // ẨN: Thêm class d-none
                }
            }
        }
    </script>
