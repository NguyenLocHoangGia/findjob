                            ...
                            <form action="/recruiter/job/save" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control bg-light" name="companyName" value="${company.companyName}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control bg-light" name="location" value="${company.companyAddress}" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted fst-italic">Nhập tóm tắt hấp dẫn để thu hút ứng viên.</small>
                                </div>

                                <div class="mb-4 mt-4">
                                    <label class="form-label fw-bold">Mô tả chi tiết và Yêu cầu <span class="text-danger">*</span></label>
                                    <textarea class="form-control bg-light" name="description" rows="6" required placeholder="- Yêu cầu kỹ năng...">${company.description}</textarea>
                                </div>

                                <div class="mb-3 border rounded p-3 bg-light">
                                    <label for="logoFile" class="form-label fw-bold mb-1">Logo hiển thị cho tin này</label>
                                    <p class="text-muted small mb-2 text-info"><i class="bi bi-info-circle"></i> Hệ thống sẽ tự dùng Logo Công ty nếu bạn không chọn tệp mới.</p>
                                    <input class="form-control bg-white" type="file" id="logoFile" accept=".png, .jpg, .jpeg" name="logoFile" onchange="previewLogo(event)"/>
                                </div>

                                <div id="previewContainer" class="mb-4 text-center <c:if test='${empty company.companyLogo}'>d-none</c:if>">
