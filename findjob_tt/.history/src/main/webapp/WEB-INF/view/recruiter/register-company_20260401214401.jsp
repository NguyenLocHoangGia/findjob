<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <textarea class="form-control bg-light" name="description" rows="5" required 
              placeholder="Nhập mô tả ngắn gọn về lĩnh vực hoạt động, văn hóa công ty..."></textarea>
</div>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Địa chỉ chi tiết Trụ sở <span
                                            class="text-danger">*</span></label>
