                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <c:forEach var="app" items="${applications}">
                                            <tr>
                                                <td class="ps-4 fw-bold text-dark">${app.candidateName}</td>
                                                <td>${app.candidateEmail}</td>
                                                <td class="text-muted small">${app.formattedApplyDate}</td>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group shadow-sm">
                                                        ...
                                                        <a href="/uploads/cv_files/${app.cvFileName}" target="_blank" class="btn btn-sm btn-outline-primary">
