                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Quản lý các tin tuyển dụng và theo dõi ứng viên của
                                        bạn.</p>
                                </div>
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-header bg-white border-bottom py-3">
                                    <h5 class="mb-0 fw-bold text-dark"><i
                                            class="bi bi-list-task me-2 text-primary"></i>Danh sách công việc</h5>
                                </div>
                                                    ...
                                                    <tr class="job-row" data-title="${job.title}"
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <div class="btn-group shadow-sm">
                                                                ...
                                                                <a href="/recruiter/edit-job/${job.id}"
