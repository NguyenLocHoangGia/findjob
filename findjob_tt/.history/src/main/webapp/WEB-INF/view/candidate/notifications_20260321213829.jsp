<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    function deleteNotification(event, id) {
        ...
        // 1. Lấy CSRF Token một cách an toàn (tránh lỗi null nếu bạn đã tắt CSRF)
        let csrfToken = '';
        let csrfHeader = '';
        ...
        // Chỉ thêm Header bảo mật nếu tìm thấy Token trên trang web
        ...
        .then(async response => {
            if(response.ok) {
                // Xóa thành công -> Tạo hiệu ứng mờ dần
                ...
                // NẾU CÓ LỖI, IN RÕ MÃ LỖI LÀ GÌ (403, 404 hay 500)
                const errorText = await response.text();
                alert("Lỗi " + response.status + ": " + errorText);
            }
        })
        .catch(err => {
            alert("Lỗi kết nối JavaScript: " + err.message);
        });
    }
</script>
        </body>
