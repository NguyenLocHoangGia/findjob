...
<style>
    ...
    .neo-dropdown-menu {
        ...
        list-style: none !important; /* Dòng này xóa tận gốc dấu chấm đen */
        margin: 0;                   /* Dòng này xóa khoảng trống thừa bên ngoài */
        padding: 8px;                /* Dòng này thu nhỏ viền trắng xung quanh */
    ...
    /* Thu gọn khoảng cách giữa các thẻ li (các dòng menu) */
