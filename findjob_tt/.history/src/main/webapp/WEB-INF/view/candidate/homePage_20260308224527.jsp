...
<head>
    ...
    <style>
        ...
        .hero-section { background: linear-gradient(135deg, #0d6efd 0%, #0dcaf0 100%); padding: 120px 0 50px -2px; text-align: center; color: white; }
...
<body>
    ...
    <div class="container my-5 flex-grow-1">
        <h3 class="fw-bold mb-2 text-dark"><i class="bi bi-fire text-danger"></i> Việc làm mới nhất</h3>
                    ...
                    <a href="/job/${job.id}" class="text-decoration-none text-dark d-block h-100">
                        <div class="mini-card pb-3">
                            ...
                            <div class="text-center px-4 pt-2 d-flex flex-column flex-grow-1">
                                ...
                                <p class="text-muted text-clamp-2 text-start mb-4" style="font-size: 0.85rem;">${job.shortDescription}</p>
