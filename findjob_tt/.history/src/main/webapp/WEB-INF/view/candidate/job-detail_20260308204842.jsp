...
<head>
    ...
    <style>
        ...
        .profile-card {
            max-width: 700px; /* Độ rộng thẻ giống như ảnh mẫu */
            width: 100%;
...
<body>
    ...
    <div class="container mt-4">
        <a href="/" class="btn btn-outline-dark btn-sm rounded-pill px-3 shadow-sm"><i class="bi bi-arrow-left me-1"></i> Quay lại danh sách</a>
    </div>
    ...
    <div class="container d-flex flex-grow-1 justify-content-center align-items-center py-4">
        ...
        <div class="profile-card mb-4">
            ...
            <div class="tab-content content-area" id="profileTabsContent">
                ...
                <div class="tab-pane fade show active" id="about" role="tabpanel">
                    ...
                    <p class="text-muted" style="line-height: 1.8;">
                        Chào mừng bạn đến với <strong>${job.companyName}</strong>. Chúng tôi tự hào là một trong những đơn vị phát triển và năng động. Tại đây, chúng tôi luôn tạo điều kiện tốt nhất để các thành viên phát triển bản thân.
                    </p>
                </div>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel">
                    ...
                    <form action="/apply" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3"><input type="text" class="form-control bg-light border-0" name="candidateName" required placeholder="Họ và tên của bạn..."></div>
                        <div class="mb-3"><input type="email" class="form-control bg-light border-0" name="candidateEmail" required placeholder="Địa chỉ Email..."></div>
                        <div class="mb-4">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#about" type="button" role="tab">Về Chúng Tôi</button></li>
                <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#experience" type="button" role="tab">Công Việc</button></li>
                <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab">Liên Lạc</button></li>
            </ul>
