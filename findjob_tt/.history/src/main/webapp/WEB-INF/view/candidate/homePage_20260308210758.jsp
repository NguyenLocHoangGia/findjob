                    ...
                    <a href="/job/${job.id}" class="text-decoration-none text-dark d-block h-100">
                        <div class="mini-card pb-3">
                            ...
                            <div class="text-center px-4 pt-2 d-flex flex-column flex-grow-1">
                                ...
                                <p class="text-muted text-uppercase fw-bold mb-3" style="font-size: 1rem;"> Công ty: ${job.companyName}</p>

                                <div class="d-flex justify-content-center gap-2 mb-3" style="font-size: 1.5rem;">
