...
<div class="container fixed-top mt-3" style="z-index: 1050;">
    <nav class="navbar navbar-expand-lg navbar-dark rounded-pill shadow-lg px-4 py-3" style="background-color: rgba(33, 37, 41, 0.65) !important; backdrop-filter: blur(15px);">
        ...
        <div class="collapse navbar-collapse" id="headerMenu">
            <div class="ms-auto d-flex align-items-center gap-4">
                ...
                <a href="/switch-to-recruiter" class="text-white fw-medium text-decoration-none hover-scale d-flex align-items-center">
                ...
                <c:choose>
                    ...
                    <c:when test="${not empty pageContext.request.userPrincipal}">
                        ...
                        <a href="/candidate/saved-jobs" class="position-relative text-white hover-scale mt-1" title="Việc làm đã lưu">
                            ...
                            <span id="header-saved-count" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger border border-dark" style="font-size: 0.7rem; padding: 0.35em 0.55em;">
                                ${not empty savedItemsCount ? savedItemsCount : 0}
                            </span>
                        </a>

                        <a href="/candidate/notifications" class="position-relative text-white hover-scale mt-1 ms-3" title="Thông báo ứng tuyển">
                            <i class="bi bi-bell-fill fs-4 text-warning"></i>
                            <c:if test="${unreadNotificationsCount > 0}">
                                <span id="header-notif-count" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger border border-dark" style="font-size: 0.7rem; padding: 0.35em 0.55em;">
                        ...
                        <div class="nav-item dropdown position-relative ms-2">
                            <a class="nav-link text-white d-flex align-items-center p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                ...
                                <c:choose>
    <c:when test="${fn:startsWith(sessionScope.img, 'http')}">
        <img src="${sessionScope.img}" alt="Avatar" class="rounded-circle" style="width: 30px; height: 30px; object-fit: cover;">
    </c:when>
    <c:otherwise>
        <img src="/uploads/avatars/${sessionScope.img}" alt="Avatar" class="rounded-circle" style="width: 30px; height: 30px; object-fit: cover;">
    </c:otherwise>
</c:choose>
                            ...
                            <ul class="dropdown-menu dropdown-menu-center shadow-lg border-0 mt-3 rounded-4 p-2" style="min-width: 220px; background-color: rgba(255, 255, 255, 0.95);">
                                ...
                                <li>
                                    <a class="dropdown-item py-2 rounded-3 fw-medium mb-1" href="/candidate/my-applications">
                                        <i class="bi bi-clock-history text-success me-2"></i> Lịch sử ứng tuyển
                                    </a>
                                </li>
