            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="custom-card p-4">
                        ...
                        <c:choose>
                            <!--  Nếu công việc có lưu logo thật  -->
                            <c:when test="${not empty job.logo}">
                                <img src="/images/job_logos/${job.logo}" class="company-logo shadow-sm" alt="Logo">
                            </c:when>
                            
                            <!-- Nếu không có logo, dùng ảnh chữ cái mặc định -->
                            <c:otherwise>
                    ...
                    <div class="custom-card p-4 sticky-form border-top border-bottom border-4 border-primary">
                        ...
                        <form action="/apply" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-light" name="candidateName" required placeholder="Nhập tên của bạn">
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label fw-semibold text-secondary small">Email liên hệ <span class="text-danger">*</span></label>
                                <input type="email" class="form-control bg-light" name="candidateEmail" required placeholder="name@example.com">
                            </div>
                            
                            <div class="mb-4">
                                <label class="form-label fw-semibold text-secondary small">Tải lên CV (PDF) <span class="text-danger">*</span></label>
                                <input class="form-control bg-light" type="file" name="cvFile" accept=".pdf" required>
                                <small class="text-muted d-block mt-1" style="font-size: 0.75rem;">Chỉ chấp nhận định dạng .pdf (Tối đa 5MB)</small>
                            </div>
