    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <body>
                            ...
                            <form action="/" method="GET" class="input-group shadow-lg"
                                ...
                                <div class="location-input-wrapper">
                                    <input type="text" id="locationInput" name="location" value="${location}"
                                        class="form-control border-0 border-start py-3 px-3 shadow-none"
                                        placeholder="Nhập tỉnh/thành phố..." autocomplete="off" style="cursor: text;">
                                    <ul id="locationSuggestions" class="location-suggestions"></ul>
                                </div>
            ...
            <script>
                ...
                function showLocationSuggestions(keyword) {
                    ...
                    locationSuggestions.innerHTML = matched
                ...
                locationSuggestions.addEventListener('mousedown', function (event) {
