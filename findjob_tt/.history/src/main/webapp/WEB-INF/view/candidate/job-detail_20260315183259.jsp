                            ...
                            <div class="mb-4">
                                ...
                                <c:if test="${not empty candidate.cvUrl}">
                                    <small class="text-success d-block mt-1" style="font-size: 0.75rem;">
                                        <i class="bi bi-file-earmark-check-fill"></i> Hệ thống sẽ dùng CV sẵn có.
                                    </small>
                                </c:if>

                                <div id="cvPreviewContainer" class="mt-3 <c:if test='${empty candidate.cvUrl}'>d-none</c:if>">
                                    <p class="text-muted small mb-2">Xem trước CV:</p>
                                    <iframe id="cvPreview" 
                                            src="${not empty candidate.cvUrl ? '/uploads/cv_files/'.concat(candidate.cvUrl) : ''}" 
