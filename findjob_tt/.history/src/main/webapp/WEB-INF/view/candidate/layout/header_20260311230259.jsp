...
<div class="container fixed-top mt-3 z-3">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark rounded-pill shadow-lg px-4 py-3" style="background-color: rgba(33, 37, 41, 0.74) !important; backdrop-filter: blur(15px);">
        ...
        <div class="collapse navbar-collapse" id="headerMenu">
            ...
            <div class="ms-auto d-flex align-items-center gap-4">
                ...
                <a href="/candidate/saved-jobs" class="position-relative text-white hover-scale mt-1" title="Việc làm đã lưu">
                    ...
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger border border-dark" style="font-size: 0.7rem; padding: 0.35em 0.55em;">
                        3
                ...
                <div class="nav-item dropdown position-relative">
                    ...
                    <a class="nav-link text-white d-flex align-items-center p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                        <i class="bi bi-person-circle fs-3 text-info hover-scale"></i>
                        <i class="bi bi-caret-down-fill ms-1 mt-1 hover-scale" style="font-size: 0.75rem;"></i>
                    </a>
                    
                    <ul class="dropdown-menu dropdown-menu-center shadow-lg border-0 mt-3 rounded-4 p-2" style="min-width: 250px; background-color: rgba(255, 255, 255, 0.95);">
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item py-2 rounded-3 fw-medium" href="/upgrade-recruiter">
                                <i class="bi bi-building-up text-success me-2"></i> Trở thành Nhà tuyển dụng
                            </a>
                        </li>
...
<style>
    ...
    /* Class đặc biệt để ép Dropdown nằm ngay chính giữa icon */
