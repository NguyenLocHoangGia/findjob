...
<div class="container fixed-top mt-3 z-3">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark rounded-pill shadow-lg px-4 py-3" style="background-color: rgba(33, 37, 41, 0.97) !important; backdrop-filter: blur(15px);">
