...
<style>
    ...
    /* Thẻ Nav phong cách NeoNav (Đã chỉnh lại độ dài theo ảnh) */
    .glass-pill-nav {
        pointer-events: auto; 
        background: #1e2b45; /* Màu xanh đen nhám giống hệt ảnh mẫu */
        border: 1px solid rgba(255, 255, 255, 0.05); 
        
        border-radius: 50px; 
        margin: 0 auto;
        
        /* CẬP NHẬT: Độ dài chuẩn gọn gàng hơn */
        max-width: 980px; 
        width: 92%; 
    ...
    .btn-neo-start:hover { transform: scale(1.03); color: white; }

    /* ========================================================
       CẬP NHẬT MỚI: CSS CHO HOVER DROPDOWN VÀ CĂN GIỮA
       ======================================================== */
    .dropdown-container { 
        position: relative; 
    }
    ...
    .neo-dropdown-menu .dropdown-item:hover {
        ...
        color: #ff4757; 
        transform: translateX(5px); /* Trượt nhẹ chữ sang phải tạo cảm giác tương tác */
    }
</style>
                ...
                <div class="d-flex align-items-center gap-4 pe-2 mt-3 mt-lg-0">
                    ...
                    <div class="dropdown-container">
                        ...
                        <a class="btn btn-neo-start" href="/recruiter/dashboard">
                            Nhà tuyển dụng <i class="bi bi-caret-down-fill ms-2" style="font-size: 0.75rem;"></i>
                        </a>
