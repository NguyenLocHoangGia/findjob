                            ...
                            <div class="col-md-4 text-center border-end">
                                ...
                                <div class="mb-3 text-start">
                                    ...
                                    <c:if test="${not empty candidateProfileDTO.existingCv}">
                                        <div class="mt-3 p-3 border rounded bg-white shadow-sm d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <i class="bi bi-file-pdf-fill text-danger fs-2 me-3"></i>
                                                <div>
                                                    <div class="fw-bold small text-dark">Hồ sơ năng lực (CV)</div>
                                                    <div class="text-muted" style="font-size: 0.7rem;">Định dạng: PDF</div>
                                                </div>
                                            </div>
                                            <a href="/uploads/cv_files/${candidateProfileDTO.existingCv}" target="_blank" class="btn btn-sm btn-success px-3">
