...
<div class="container my-5 flex-grow-1">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <a href="/job/${job.id}" class="text-decoration-none text-dark d-block h-100">
                        <div class="mini-card hover-lift"> <div class="me-3 flex-shrink-0">
                                <img src="https://ui-avatars.com/api/?name=${job.user.companyName}&background=0D8ABC&color=fff&size=120&font-size=0.4" class="mini-logo-img" alt="Logo">
                            <div class="card-body-content flex-grow-1 overflow-hidden h-100 position-relative">
                                ...
                                <p class="text-muted text-uppercase fw-bold mb-2" style="font-size: 0.75rem;">${job.user.companyName}</p>
    ...
    <script>
        function toggleWishlist(event) { // Bỏ jobId ở đây đi
            event.stopPropagation();
            event.preventDefault();

            const btn = event.currentTarget;
            const jobId = btn.getAttribute('data-job-id'); // Móc ID từ HTML ra
