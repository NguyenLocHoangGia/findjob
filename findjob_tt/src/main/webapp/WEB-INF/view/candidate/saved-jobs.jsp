                    ...
                    <div class="col-md-10">
                        <div class="card shadow-sm border-0 rounded-4 p-4">
                            ...
                            <div class="d-flex align-items-center border-bottom pb-3 mb-4">
                                <div class="bg-danger text-white rounded-circle d-flex align-items-center justify-content-center me-3 shadow"
                                ...
                                <%-- TRƯỜNG HỢP 1: TRỐNG --%>
                                    <c:when test="${empty savedJobsList}">
                                        <div class="text-center py-5">
                                            <i class="bi bi-clipboard-x text-muted opacity-25"
                                                style="font-size: 4rem;"></i>
                                            <h5 class="text-muted fw-bold mt-3">Bạn chưa lưu công việc nào</h5>
                                            <p class="text-muted small mb-4">Các công việc bạn "thả tim" sẽ xuất hiện
                                                tại đây.</p>
                                                    ...
                                                    <div class="col-lg-6 col-xl-6" id="job-card-${job.id}">
                                                        <div class="mini-card hover-lift">
                                                            <button class="wishlist-btn" type="button"
                                                                data-job-id="${job.id}" onclick="removeSavedJob(event)">
                                                                <i class="bi bi-heart-fill"></i>
                                                            </button>
                                                            ...
                                                            <a href="/job/${job.id}"
                                                                ...
                                                                <div class="me-3">
                                                                    <c:choose>
                                                                        <c:when test="${not empty job.logo}">
                                                                            <img src="/uploads/job_logos/${job.logo}"
                                                                                class="mini-logo-img"
                                                                                onerror="this.onerror=null; this.src='/uploads/company_logos/${job.logo}';"
                                                                                alt="Logo">
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <img src="https://ui-avatars.com/api/?name=${job.companyName}&background=0D8ABC&color=fff&size=120"
                                                                ...
                                                                <div class="flex-grow-1 overflow-hidden pe-4">
                                                                    ...
                                                                    <p class="text-primary fw-semibold mb-2"
                                                                        style="font-size: 0.75rem;">${job.companyName}
                                                                    </p>

                                                                    <div class="d-flex flex-wrap gap-2">
                                                                        <span
                                                                            class="badge bg-light text-success border border-success border-opacity-10 py-1">
                                                                            <i class="bi bi-cash me-1"></i>
                                                                            ${job.salary}
                                                                        </span>
                                                                        <span
                                                                            class="badge bg-light text-secondary border border-secondary border-opacity-10 py-1">
