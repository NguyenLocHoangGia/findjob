                            ...
                            <a class="nav-link text-white d-flex align-items-center p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                ...
                                <c:choose>
                                    <c:when test="${not empty sessionScope.img}">
                                        <img src="/uploads/avatars/${sessionScope.img}" alt="Avatar" class="rounded-circle object-fit-cover border border-2 border-info hover-scale" style="width: 40px; height: 40px;">
                                    </c:when>
                                    <c:otherwise>
