        ...
        <body>
            ...
            <div class="hero-section shadow-sm">
                <div class="container container-custom">
                    <h1 class="fw-bold mb-3 fs-2" style="text-shadow: 0 2px 4px rgba(0,0,0,0.3);">Mạng Lưới Việc Làm 
                        Hàng Đầu</h1>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7 col-md-10">
                            ...
                            <form action="${isAllJobsPage ? '/jobs' : '/'}" method="GET" class="input-group shadow-lg"
                                ...
                                <select name="salaryRange"
                                    class="form-select border-0 border-start py-3 shadow-none text-muted"
                                    style="flex: 1; cursor: pointer; min-width: 170px;">
                                    <option value="">Tất cả mức lương</option>
                                    <option value="NEGOTIABLE" ${salaryRange=='NEGOTIABLE' ? 'selected' : '' }>Thỏa thuận</option>
                                    <option value="LT5" ${salaryRange=='LT5' ? 'selected' : '' }>&lt; 5 triệu</option>
                                    <option value="FROM5TO15" ${salaryRange=='FROM5TO15' ? 'selected' : '' }>5 - 15 triệu</option>
                                    <option value="GT15" ${salaryRange=='GT15' ? 'selected' : '' }>&gt; 15 triệu</option>
                                </select>
                ...
                <c:if test="${not empty hotJobs}">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <c:if test="${hasMoreHotJobs}">
                            <a href="/jobs?keyword=${keyword}&location=${location}&category=${categoryId}&salaryRange=${salaryRange}"
