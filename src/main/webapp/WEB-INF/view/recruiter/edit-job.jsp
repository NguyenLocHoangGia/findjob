...
<head>
    ...
    <style>
        ...
        .required-skill-row { background: #fff; border: 1px solid #e9ecef; border-radius: 12px; padding: 14px; }
                            ...
                            <form action="/recruiter/edit-job" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4 border rounded p-3 bg-light">
                                    ...
                                    <div id="requiredSkillsList" class="d-flex flex-column gap-2">
                                        <c:choose>
                                            <c:when test="${not empty jobRequiredSkills}">
                                                    ...
                                                    <div class="required-skill-row">
                                                        <div class="row g-2 align-items-end">
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" class="form-control" name="requiredSkillNames" value="${skill.skillName}" placeholder="spring boot">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label class="form-label small fw-semibold">Loại</label>
                                                                <select class="form-select" name="requiredSkillTypes">
                                                                    <option value="REQUIRED" ${skill.skillType == 'REQUIRED' ? 'selected' : ''}>Bắt buộc</option>
                                                                    <option value="PREFERRED" ${skill.skillType == 'PREFERRED' ? 'selected' : ''}>Ưu tiên</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label class="form-label small fw-semibold">Năm KN</label>
                                                                <input type="number" class="form-control" name="requiredSkillMinYears" min="0" step="0.5" value="${skill.minYears}" placeholder="0">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label class="form-label small fw-semibold">Trọng số</label>
                                                                <input type="number" class="form-control" name="requiredSkillWeights" min="1" max="10" step="1" value="${skill.weight}">
                                                            </div>
