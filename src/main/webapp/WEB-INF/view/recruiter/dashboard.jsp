                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Tổng quan hiệu suất tuyển dụng và 5 tin gần nhất.</p>
                                </div>
                                <div class="d-flex gap-2">
                                    <a href="/recruiter/jobs" class="btn btn-dark fw-bold shadow-sm">
                                        <i class="bi bi-sliders me-2"></i> Quản lý công việc
                                    </a>
                            ...
                            <c:if test="${not empty successMsg}">
                                <div class="alert alert-success alert-dismissible fade show fw-bold border-0 shadow-sm"
                                    role="alert">
                            ...
                            <p class="text-muted small mb-2"><i class="bi bi-info-circle"></i> Nhấp vào các thẻ bên dưới
                                để sắp xếp bảng công việc</p>

                            <div class="row g-4 mb-4">
                                <div class="col-md-4">
                                    <div class="card bg-primary text-white border-0 shadow-sm rounded-4 h-100 p-3 hover-lift"
                                        id="sort-title" onclick="sortJobs('title')">
                                        <div class="card-body d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 text-white-50 fw-semibold text-uppercase"
                                                    style="font-size: 0.8rem; letter-spacing: 0.5px;">Tổng chiến dịch
                                                </p>
                                                <h2 class="mb-0 fw-bold display-6">${not empty totalJobs ? totalJobs :
                                                    0}</h2>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card bg-success text-white border-0 shadow-sm rounded-4 h-100 p-3 hover-lift"
                                        id="sort-total" onclick="sortJobs('total')">
                                        <div class="card-body d-flex align-items-center">
                                            <div class="bg-white bg-opacity-25 rounded-circle d-flex align-items-center justify-content-center me-3"
                                                style="width: 65px; height: 65px;">
                                            ...
                                            <div>
                                                <p class="mb-0 text-white-50 fw-semibold text-uppercase"
                                                    style="font-size: 0.8rem; letter-spacing: 0.5px;">Tổng hồ sơ nhận
                                                </p>
                                                <h2 class="mb-0 fw-bold display-6">${not empty totalCandidates ?
                                                    totalCandidates : 0}</h2>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card bg-warning text-dark border-0 shadow-sm rounded-4 h-100 p-3 hover-lift"
                                        id="sort-pending" onclick="sortJobs('pending')">
                                        <div class="card-body d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 text-dark opacity-75 fw-semibold text-uppercase"
                                                    style="font-size: 0.8rem; letter-spacing: 0.5px;">Chờ xử lý</p>
                                                <div class="d-flex align-items-center">
                                                    <h2 class="mb-0 fw-bold display-6">${not empty pendingCandidates ?
                                                        pendingCandidates : 0}</h2>
                                                </div>
                                            </div>
                                            <i class="bi bi-sort-numeric-down-alt fs-4 ms-auto opacity-50"></i>
                                        </div>
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-header bg-white border-bottom py-3">
                                    <h5 class="mb-0 fw-bold text-dark"><i
                                            class="bi bi-list-task me-2 text-primary"></i>5 công việc gần nhất</h5>
                                </div>
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle mb-0">
                                            <thead>
                                                <tr class="text-secondary small text-uppercase">
                                                    ...
                                                    <th class="py-3" width="20%">Ngày đăng</th>
                                                    <th class="text-center py-3" width="20%">Điều hướng</th>
                                                </tr>
                                            </thead>
                                            <tbody id="job-tbody">
                                                <c:forEach var="job" items="${jobs}" varStatus="status" begin="0" end="4">
                                                    ...
                                                    <tr class="job-row" data-title="${job.title}"
                                                        data-total="${not empty job.applications ? job.applications.size() : 0}"
                                                        data-pending="${pendingCount}">

                                                        <td class="text-center align-middle stt-cell">${status.index +
                                                            1}</td>
                                                        <td class="align-middle">
                                                            <a href="/job/${job.id}" target="_blank"
                                                                class="job-title-link fw-bold">${job.title}</a>
                                                            <div class="small text-muted"><i
                                                                    class="bi bi-geo-alt me-1"></i>${job.location}</div>
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <span
                                                                class="badge bg-info-subtle text-info-emphasis rounded-pill px-3 py-1">
                                                                ${not empty job.applications ? job.applications.size() :
                                                                0} hồ sơ
                                                            </span>
                                                            <c:if test="${pendingCount > 0}">
                                                                <div class="small text-danger mt-1 fw-medium"><i
                                                                        class="bi bi-exclamation-circle"></i>
                                                                    ${pendingCount} chờ duyệt</div>
                                                            </c:if>
                                                        </td>
                                        ...
                                        <c:if test="${empty jobs}">
                                            <div class="text-center py-5" id="empty-state">
                                                <i
                                                    class="bi bi-clipboard-x fs-1 text-muted d-block mb-3 opacity-50"></i>
                                                <h5 class="text-muted fw-bold">Bạn chưa có bài đăng nào</h5>
                                                <p class="small text-muted">Bắt đầu thu hút nhân tài bằng cách đăng tin
                                                    tuyển dụng đầu tiên.</p>
                                                <a href="/recruiter/job/add"
                                                    class="btn btn-primary btn-sm mt-2 rounded-pill px-4">Đăng tin
                                                    ngay</a>
                                            </div>
                                        </c:if>
                                    </div>
                                    ...
                                    <div class="card-footer bg-white border-top py-3 d-flex justify-content-between align-items-center"
                                        id="pagination-container" style="display: none !important;">
                                        <span class="text-muted small" id="page-info">Hiển thị 0 - 0 trong 0 công
                                            việc</span>
                    ...
                    <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
                        ...
                        <div class="modal-body px-4 py-4">
                            ...
                            <div class="alert alert-danger bg-danger-subtle border-0 mb-0">
                                <i class="bi bi-info-circle-fill me-2"></i>Toàn bộ dữ liệu và hồ sơ ứng viên của công
                                việc này sẽ bị xóa và <b>không thể khôi phục</b>.
                            </div>
                        </div>
